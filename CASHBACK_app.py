...
vtb = {
    ('vtb', 'дом и ремонт', 0.04, 3000, 'all', 1, 3, 0),
    ('vtb', 'аптеки', 0.04, 3000, 'all', 1, 3, 0),
    ('vtb', 'ювелирные изделия', 0.15, 3000, 'all', 1, 3, 0),
    ('vtb', 'детские товары', 0.04, 3000, 'all', 1, 3, 0),
    ('vtb', 'цветы', 0.08, 3000, 'all', 1, 3, 0),
    ('vtb', 'здоровье', 0.04, 3000, 'all', 1, 3, 0),
}
