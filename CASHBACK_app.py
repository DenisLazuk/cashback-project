...
tbank = {
    ...
    ('tbank', 'подарки', 0.05, 5000, 'all', 1, 4, 0),
    ('tbank', 'спорттовары', 0.05, 5000, 'all', 1, 4, 0),
    ('tbank', 'рестораны', 0.05, 5000, 'all', 1, 4, 0)
}
...
# Условия: 5000 суммарный размер кешбека в месяц по всем категориям
sber = {
    ('sber', 'кафе и рестораны', 0.05, 5000, 'all', 1, 3, 0),
    ('sber', 'досуг', 0.05, 5000, 'all', 1, 3, 0),
    ('sber', 'спорт', 0.05, 5000, 'all', 1, 3, 0),
    ('sber', 'одежда', 0.02, 5000, 'all', 1, 3, 0),
    ('sber', 'медицина', 0.02, 5000, 'all', 1, 3, 0),
    ('sber', 'образование', 0.05, 5000, 'all', 1, 3, 0)
}
...
alpha = {
    ...
    ('alpha', 'техника', 0.02, 5000, 'all', 1, 3, 0),
    ('alpha', 'книги', 0.05, 5000, 'all', 1, 3, 0),
    ('alpha', 'фастфуд', 0.1, 5000, 'all', 1, 3, 0),
    ('alpha', 'образование', 0.05, 5000, 'all', 1, 3, 0),
    ('alpha', 'аптеки', 0.02, 5000, 'all', 1, 3, 0),
    ('alpha', 'салоны красоты', 0.05, 5000, 'all', 1, 3, 0)
}

# OTP Bank
# Условия: 3000 суммарный размер кешбека в месяц по всем категориям
otp = {
    ('otp', 'одежда', 0.05, 3000, 'all', 1, 4, 0),
    ('otp', 'аптеки', 0.02, 3000, 'all', 1, 4, 0),
    ('otp', 'продукты', 0.02, 3000, 'all', 1, 4, 0),
...
vtb = {
    ('vtb', 'продукты', 0.015, 1000, 'all', 1, 3, 0),
    ('vtb', 'спорттовары', 0.04, 3000, 'all', 1, 3, 0),
    ('vtb', 'книги', 0.15, 3000, 'all', 1, 3, 0),
    ('vtb', 'такси', 0.04, 3000, 'all', 1, 3, 0),
    ('vtb', 'образование', 0.06, 1000, 'one', 1, 3, 0),
    ('vtb', 'цветы', 0.1, 1000, 'one', 1, 3, 0)
}
